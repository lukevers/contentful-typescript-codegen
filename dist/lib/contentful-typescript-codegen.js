...
var loadEnvironment_1 = require("./loadEnvironment");
...
function runCodegen(outputFile) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, loadEnvironment_1.loadEnvironment()];
                case 1:
                ...
                case 2:
                    output = _b.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, render_1.default(contentTypes.items, locales.items, {
